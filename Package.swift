...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "DAMod",
            url: "https://github.com/acoustic-analytics/DigitalAnalytics/releases/download/1.1.61/DAMod_XCFramework_Debug.zip",
            checksum: "7d69fab2738f7eb2a4e1226d1eedd842c811d60119368efcf34639f5f95daec4"),
        .binaryTarget(
            name: "EOCore",
