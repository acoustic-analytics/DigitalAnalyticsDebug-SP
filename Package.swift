...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "DAMod",
            url: "https://github.com/acoustic-analytics/DigitalAnalytics/releases/download/1.1.105/DAMod_XCFramework_Debug.zip",
            checksum: "6e0fb665a86bd6ed72264ea74cb6049d3481427a9c895342f35986f185f5dc3f"),
        .binaryTarget(
            name: "EOCore",
