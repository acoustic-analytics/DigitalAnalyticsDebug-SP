...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "DAMod",
            url: "https://github.com/acoustic-analytics/DigitalAnalytics/releases/download/1.1.70/DAMod_XCFramework_Debug.zip",
            checksum: "9dbb35cd538dcb5a21775be9734f16312d10763ded004f5e384b858f8f61fe6f"),
        .binaryTarget(
            name: "EOCore",
