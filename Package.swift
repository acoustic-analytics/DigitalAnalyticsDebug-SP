...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "DAMod",
            url: "https://github.com/acoustic-analytics/DigitalAnalytics/releases/download/1.1.92/DAMod_XCFramework_Debug.zip",
            checksum: "230e3cab4b0b41cc8f2b66ae0b88eaa2032f74911e7ee3fb4d8f20b7e9a01423"),
        .binaryTarget(
            name: "EOCore",
