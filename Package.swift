...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "DAMod",
            url: "https://github.com/acoustic-analytics/DigitalAnalytics/releases/download/1.1.77/DAMod_XCFramework_Debug.zip",
            checksum: "33b6a9ea6354e57d4bfd0f0d38d9280dca2cc792a36c240b68776e02f0eeb934"),
        .binaryTarget(
            name: "EOCore",
