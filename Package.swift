...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "DAMod",
            url: "https://github.com/acoustic-analytics/DigitalAnalytics/releases/download/1.1.38/DAMod_XCFramework_Debug.zip",
            checksum: "288da876235c22e3cca01e18557e59b08d6cbeaa376dc9a05f5b8364034cb5ae"),
        .binaryTarget(
            name: "EOCore",
