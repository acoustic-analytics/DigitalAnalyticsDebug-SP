...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "DAMod",
            url: "https://github.com/acoustic-analytics/DigitalAnalytics/releases/download/1.1.85/DAMod_XCFramework_Debug.zip",
            checksum: "e0b5b43b00116ec7d9c45364a7055f1b6b7ba29996bb11a8e61aa81a19573d3e"),
        .binaryTarget(
            name: "EOCore",
